...
--
-- Name: properties atomic_num_fk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT atomic_num_fk FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
